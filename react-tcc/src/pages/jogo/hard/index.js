...
function Hard() {
  const imagens = [
    '/assets/img/produtos/tinta1(1).png', '/assets/img/produtos/imag7.png', '/assets/img/paleta.jpg', '/assets/img/tintapiso.jpg','/assets/img/tintapiso2.jpg','/assets/img/tintapiso3.png',
    '/assets/img/produtos/tinta1(1).png', '/assets/img/produtos/imag7.png', '/assets/img/paleta.jpg', '/assets/img/tintapiso.jpg','/assets/img/tintapiso2.jpg','/assets/img/tintapiso3.png',
  ];
